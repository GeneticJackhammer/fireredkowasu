...
#define IS_TYPE_PHYSICAL(moveType)(moveType == TYPE_DARK || (moveType != TYPE_GHOST && moveType < TYPE_MYSTERY))
#define IS_TYPE_SPECIAL(moveType)(moveType == TYPE_GHOST || (moveType != TYPE_DARK && moveType > TYPE_MYSTERY))
